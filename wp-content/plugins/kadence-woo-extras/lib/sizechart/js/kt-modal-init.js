      ...
      createClass(Modal, [
                ...
                bodyScrollLock.disableBodyScroll(targetElement, {
                  allowTouchMove: (el) => {
                    while (el && el !== document.body) {
                      if (
                        el.classList.contains("kt-modal-content") ||
                        el.classList.contains("kt-modal-container") ||
        ...
        },
        {
          ...
          value: function setFocusToFirstNode() {
            ...
            if (this.modal.querySelector(".modal-content")?.offsetHeight > 900)
              return;
