...
namespace KadenceWP\KadenceShopKit\StellarWP\Telemetry;

use KadenceWP\KadenceShopKit\StellarWP\ContainerContract\ContainerInterface;
use KadenceWP\KadenceShopKit\StellarWP\Telemetry\Admin\Admin_Subscriber;
use KadenceWP\KadenceShopKit\StellarWP\Telemetry\Admin\Resources;
use KadenceWP\KadenceShopKit\StellarWP\Telemetry\Contracts\Data_Provider;
use KadenceWP\KadenceShopKit\StellarWP\Telemetry\Data_Providers\Debug_Data;
use KadenceWP\KadenceShopKit\StellarWP\Telemetry\Events\Event_Subscriber;
use KadenceWP\KadenceShopKit\StellarWP\Telemetry\Exit_Interview\Exit_Interview_Subscriber;
use KadenceWP\KadenceShopKit\StellarWP\Telemetry\Exit_Interview\Template;
use KadenceWP\KadenceShopKit\StellarWP\Telemetry\Last_Send\Last_Send;
use KadenceWP\KadenceShopKit\StellarWP\Telemetry\Last_Send\Last_Send_Subscriber;
use KadenceWP\KadenceShopKit\StellarWP\Telemetry\Opt_In\Opt_In_Subscriber;
use KadenceWP\KadenceShopKit\StellarWP\Telemetry\Opt_In\Opt_In_Template;
use KadenceWP\KadenceShopKit\StellarWP\Telemetry\Opt_In\Status;
use KadenceWP\KadenceShopKit\StellarWP\Telemetry\Telemetry\Telemetry;
use KadenceWP\KadenceShopKit\StellarWP\Telemetry\Telemetry\Telemetry_Subscriber;
...
class Core {
	 ...
	 * @since 1.0.0
	 *
	 * @return \KadenceWP\KadenceShopKit\StellarWP\ContainerContract\ContainerInterface
	 */
