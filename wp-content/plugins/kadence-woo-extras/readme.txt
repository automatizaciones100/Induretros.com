...
== Changelog ==
= 2.4.15.1 | 1st April 2026 =
* Update: Product blocks now use the latest WordPress block API for better compatibility with WordPress 7.0. 

= 2.4.15 | 25th February 2026 =
* Update: Missing files for new prebuilt templates for Woo Templates

= 2.4.14 | 25th February 2026 =
* Add: New prebuilt templates for Woo Templates
* Fix: Gallery options don’t appear if a different gallery type is selected for desktop.
* Fix: Issue with Quickview Multisite
* Fix: Product: Tabs block style settings not working on frontend.
* Fix: Safety checks in kt-badges.php file.

= 2.4.13 | 11th February 2026 =
* Add: Option show product variations in quickview, but not the archive.

= 2.4.12 | 6th November 2025 =
* Add: Filter for advanced review author name.

= 2.4.11 | 9th October 2025 =
* Fix: Issue with product gallery margins when switching in variation images.
* Fix: issue with badge checks on non product single pages.
* Add: Quickview button block
* Add: Quickview button single page placement option.

= 2.4.10 | 23rd July 2025 =
* Add: Global function to initialize variation swatches outside of the plugin.
* Fix: Product Description block in product loop woo template.

= 2.4.9 | 19th June 2025 =
* Fix: Gallery arrows showing up when there are no additional images.

= 2.4.8 | 29th May 2025 =
* Fix: Variations images are not changing using advanced query loop
* Fix: Shop Kit Affiliate Product Options breaks Badges display on archive
* Fix: Width/height issue with Shop Kit Size Chart buttons in WP 6.8

= 2.4.7 | 28th April 2025 =
* Fix: Added more safety checks to telemetry opt-ins/opt-outs.

= 2.4.6 | 17rd April 2025 =
* Fix: Error when setting "Show on products with certain tags" without selecting any tags.

= 2.4.5 | 3rd April 2025 =
* Update: allow for license key embeds.
* Fix: Issue with title showing on image.

= 2.4.4 | 25th March 2025 =
* Update: woocommerce template file override version numbers.
* Fix: Issue with variation swatches always using variable product custom add to cart text

= 2.4.3 | 18th March 2025 =
* Fix: Issue with product brands column width in admin
* Fix: Product badges throwing error on cart page when cart block is added

= 2.4.2 | 12th February 2025 =
* Fix: Issue with Snackbar notices scroll in checkout
* Fix: Error when woo templates is disabled and quickview is.

= 2.4.1 | 28th January 2025 =
* Fix: Issue with Product Galleries javascript selectors

= 2.4.0 | 27th January 2025 =
* Add: Product Quickview.
* Fix: Issue with funnelkit side cart and variation swatches
* Fix: Issue with product tabs in Woo templates
* Fix: variation images not updating with swatches in Query Loop blocks

= 2.3.4 | 13th December 2024 =
* Fix: Issue with selecting attributes for Size Chart placement
* Fix: Issue when opening size chart's with long content

= 2.3.3 | 5th December 2024 =
* Add: settings to inherit kadence theme global heading/body fonts.
* Fix: Issue product gallery vertical layouts/sliders.
* Fix: undefined variable warning.
* Fix: Issue with badges when using the low stock condition on checkout pages.

= 2.3.3 | 5th December 2024 =
* Fix: Issue with badges using the low stock condition on checkout pages.

= 2.3.2 | 28th October 2024 =
* Fix: Issue with variation swatches default sizes.
* Fix: Issue with badge 0 value borders, border radius, padding, and margins.

= 2.3.1 | 18th October 2024 =
* Fix: Issue with variation swatches radio display.

= 2.3.0 | 17th October 2024 =
* Add: Product Badges feature.
* Enchancement: Including swatch meta data in the woocommerce import export process
* Enchancement: Replies to advanced reviews now display like replies (may require re-import)
* Fix: Issue with custom billing and shipping fields duplicate meta keys
* Fix: Issue with galleries and other components not loading on woocommerce single page shortcode
* Fix: Issue with multiple add to cart variation swatch forms on a single page
* Fix: Conflict with ShopKit gallery slider close button and theme button styles
* Fix: Force Image to fill the container option not applying in some situations
* Fix: Issue with variation swatch sizes applying outside their scope or when disabled
* Fix: Issue with snackbar notice styling.

= 2.2.6 | 24th September 2024 =
* Fix: Issue with typing into the setting page causing a reload.

= 2.2.5 | 17th September 2024 =
* Fix: Issue when activating plugin while woocommerce is inactive.

= 2.2.4 | 23th August 2024 =
* Fix: Issue with single templates and swatches.
* Fix: Issue with archive swatch size for taxonomy defined swatches.
* Fix: Issue with convert reviews button.

= 2.2.3 | 13th August 2024 =
* Fix: Stable tag.

= 2.2.2 | 13th August 2024 =
* Fix: Swatches not wrapping on products with many variations.

= 2.2.1 | 13th August 2024 =
* Fix: License validation request issue.

= 2.2.0 | 12th August 2024 =
* Add: Swatches for Archives (Show swatches in loop templates).
* Update: New Settings Panel Design.
* Update: WooCommerce template files.
* Fix: Issue when scrolling within modals on touch devices.
* Fix: Reviews block tablet and mobile single column layout.
* Fix: Issue with styling title in loop.
